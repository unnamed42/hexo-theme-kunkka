...
$(document).ready(function(){var o=$("#toc"),t=$(".post-body");if($(window).width()>768){var s=t.position().top+t.outerHeight();toc_height=o.height(),pos_max=s-toc_height,$("ol",o).addClass("nav"),$("body").scrollspy({target:"#toc",offset:40}),$(window).scroll(function(){var t=$(window).scrollTop();o.css("top",55>t?90-t:pos_max>t?35:pos_max-t)})}});
